...
#
# If unspecifed, the destination is nightowl.local and the .fw file is naively
# guessed
#
...
help() {
    ...
    echo
    echo "Default destination IP is 'nightowl.local'"
...
[ -n "$DESTINATION" ] || DESTINATION=nightowl.local
